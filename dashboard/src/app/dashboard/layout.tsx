...
export default async function DashboardLayout({
  ...
  return (
    <div className="flex min-h-screen flex-col bg-slate-50/50 font-sans">
      <header className="sticky top-0 z-30 flex h-20 items-center gap-6 border-b border-slate-200/60 bg-white/80 backdrop-blur-md px-8 shadow-sm">
        <Link href="/dashboard/sites" className="font-sans font-black text-2xl flex items-center gap-2 text-primary tracking-tighter">
        ...
        <div className="ml-auto flex items-center gap-6">
          ...
          <div className="group relative">
            <div className="h-11 w-11 rounded-2xl bg-gradient-to-br from-primary to-primary/70 flex items-center justify-center text-white font-black text-lg shadow-lg shadow-primary/20 border-2 border-white ring-1 ring-slate-100 transition-transform group-hover:scale-105 duration-200">
